...
//
//     final pokeDetails = pokeDetailsFromJson(jsonString);

import 'dart:convert';

PokeDetails? pokeDetailsFromJson(String str) => PokeDetails.fromJson(json.decode(str));

String pokeDetailsToJson(PokeDetails? data) => json.encode(data!.toJson());
...
class PokeDetails {
    ...
    factory PokeDetails.fromJson(Map<String, dynamic> json) => PokeDetails(
